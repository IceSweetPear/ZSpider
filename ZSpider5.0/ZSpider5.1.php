...
//            print_r([$name => $url]);
            ...
            foreach ($childTasks as $childTask) {
                ...
                self::$redis::rpush('data_queue', ['urlList' => $childUrlList, 'task_name' => $childTaskName]);
    ...
    public function start($configs)
    {
        ...
        foreach ($configs as $configName => $config) {
            ...
            self::$redis::delete('data_queue');
            self::$redis::rpush('data_queue', ['urlList' => [$config['start']], 'task_name' => $childTaskName]);
            ...
            while ($index < 2) {
                ...
                if ($pid == -1) {
                    ...
                    while (true) {
                        $dataQueue = self::$redis::lpop('data_queue');
