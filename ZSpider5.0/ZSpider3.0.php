    ...
    public function doTask($taskContainer, $parentData)
    {
        ...
        foreach ($urlList as $url) {
            ...
            foreach ($childTasks as $childTask) {
                ...
                if (!isset($this->TaskQueue[$childTaskName])){
                    $this->TaskQueue[$childTaskName] = $childTask;
                }
    ...
    public function start($configs)
    {
        ...
        foreach ($configs as $configName => $config) {
            ...
            foreach ($taskContainers as $taskName => $taskContainer) {
                ...
                $this->TaskQueue[$childTaskName] = $taskContainer;

                array_push($this->DataQueue, ['urlList' => [$config['start']], 'task_name' =>$childTaskName]);
            ...
            while (!empty($this->DataQueue)){
                ...
                $taskBody = $this->TaskQueue[$taskName];

                $this->doTask($taskBody, $taskData);;
            }
...
$configs = [
    'gkw1' => [
        'start' => 'http://www.gkxx.com/shiti/list-0-0-0-0-1.html',
        '%exam_page' => [
            'name' => 'exam_page',
            'home' => 'http://www.gkxx.com',
            'urlSub' => '<a class="paginator" href="@">下一页</a>',
            'page' => false,
            'data' => [
